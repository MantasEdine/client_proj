    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col p-6 space-y-2">
          ...
          <Link 
            href="/" 
            className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-orange-50 hover:text-orange-600 transition group"
            onClick={closeSidebar}
          >
          ...
          {!user && (
            <button 
              ...
              className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-orange-50 hover:text-orange-600 transition group mt-4"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
