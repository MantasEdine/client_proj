          ...
          <div>
            ...
            <div className="text-sm space-y-2">
              ...
              <p className="flex items-center gap-2">
                ...
                <a href="mailto:haouasseyacine@gmail.com" className="hover:text-orange-600 transition break-all">haouasseyacine@gmail.com</a>
              </p>
              <p className="flex items-center gap-2">
                ...
                <a href="https://t.me/mybrandbelfort" target="_blank" rel="noopener noreferrer" className="hover:text-blue-500 transition">Telegram: @mybrandbelfort</a>
              </p>
