# N-Finity - A simple eCommerce website

N-Finity is an open-source **Next.js eCommerce frontend** project.  
...
1. Clone the repo
    ...
    ```bash
    git clone https://github.com/GreatStackDev/N-Finity.git
    cd N-Finity
    ```
...
Thanks to everyone who contributes to **N-Finity**!