                ...
                {Object.keys(cartItems).map((itemId) => {
                  ...
                  return (
                    <tr key={itemId}>
                      ...
                      <td className="py-4 md:px-4 px-1 text-gray-600">{product.offerPrice}DA</td>
                      ...
                      <td className="py-4 md:px-4 px-1 text-gray-600">{(product.offerPrice * cartItems[itemId]).toFixed(2)}DA</td>
                    </tr>
                  );
                })}
              </tbody>
